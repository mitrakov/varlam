...
class VarlamTryNow extends VarlamServlet {
  ...
  private def generateData(username: String, lang: Lang, currency: String) {
    getUser(username) foreach { user =>
      ...
      dao.persist(new Operation(gas, calendar.getTime, new BigDecimal(55), currency))
      dao.persist(new Operation(electricity, calendar.getTime, new BigDecimal(315), currency))
      dao.persist(new Operation(water, calendar.getTime, new BigDecimal(445), currency))
      dao.persist(new Operation(parking, calendar.getTime, new BigDecimal(350), currency))
      dao.persist(new Operation(petrol, calendar.getTime, new BigDecimal(500), currency))
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(205), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 2)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 3)
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(250), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 4)
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(275), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 5)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 6)
      dao.persist(new Operation(petrol, calendar.getTime, new BigDecimal(600), currency))
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(215), currency))
      ...
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(300), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 10)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(280), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 11)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(290), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 12)
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 13)
      dao.persist(new Operation(petrol, calendar.getTime, new BigDecimal(500), currency))
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(265), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 14)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(285), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 15)
      dao.persist(new Operation(parking, calendar.getTime, new BigDecimal(350), currency))
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 16)
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(270), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 17)
      dao.persist(new Operation(petrol, calendar.getTime, new BigDecimal(600), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(220), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 18)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 19)
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 20)
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(300), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 21)
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(260), currency))
      ...
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(295), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 25)
      dao.persist(new Operation(milk,calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(pork,calendar.getTime, new BigDecimal(210), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 26)
      dao.persist(new Operation(cream, calendar.getTime, new BigDecimal(40), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 27)
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(pork, calendar.getTime, new BigDecimal(230), currency))
      calendar.set(Calendar.DAY_OF_MONTH, 28)
      dao.persist(new Operation(petrol, calendar.getTime, new BigDecimal(600), currency))
      dao.persist(new Operation(milk, calendar.getTime, new BigDecimal(25), currency))
      dao.persist(new Operation(beef, calendar.getTime, new BigDecimal(285), currency))
